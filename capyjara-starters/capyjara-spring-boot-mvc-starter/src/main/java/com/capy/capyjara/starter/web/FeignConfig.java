package com.capy.capyjara.starter.web;

import com.capy.capyjara.common.exception.BusinessException;
import com.capy.capyjara.common.response.CommonResultStatus;
import com.capy.capyjara.starter.web.security.InternalRequestAuthorizationManager;
...
public class FeignConfig {
    ...
    public RequestInterceptor authInterceptor(){
        return new DefaultRequestInterceptor(InternalRequestAuthorizationManager.DEFAULT_INTERNAL_AUTH_HEADER, capyjaraWebStarterProperty.getInternalRequestSecretKey());
    }
